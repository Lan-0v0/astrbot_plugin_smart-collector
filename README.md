...
- 网站条目可开启“视频内容仅发送URL”：保留视频筛选和画质排序，直接将实体视频 URL 交给消息平台，避免插件下载完整视频。
...
网站条目的“视频内容仅发送URL”默认关闭；开启后只发送可直接访问的实体视频 URL，不发送
HLS/DASH 清单，也不会对 URL 模式的视频执行压缩。视频地址仍需由机器人协议端直接访问；
